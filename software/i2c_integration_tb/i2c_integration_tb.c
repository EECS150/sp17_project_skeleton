...
// This program works with the i2c_integration_tb to test your processor's I2C 
// memory map with the I2C controller. It attempts to perform several I2C transactions.
int main(void) {
    i2c_read(0x76, 0x01);
    i2c_write(0x76, 0x34, 0xfa);
    i2c_write(0x76, 0x85, 0x39);
    while(1){}
    return 0;
}
